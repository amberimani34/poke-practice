...
//  don't need this in here once I moved the code
// import './App.css'
...
function PokeList() {
  ...
  return (
    <>
      <h1>Pokemon App</h1>
      <p>You can search for a Pokemon by name or by id. If you aren't sure of the name, you can scroll through the list below using back and next.</p>
      <h2>Gotta Catch em' All!</h2>
      <Form newPokemon={setPokemon} />
      <h2>Look Below!</h2>
      <PokeDisplay pokemon={pokemon}/>
      { pokemon && pokemon.species ? <h3>{pokemon.species.name}</h3> : <h3>Nope..Try Again!</h3>}
